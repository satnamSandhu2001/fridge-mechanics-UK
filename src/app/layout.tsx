...
export const metadata: Metadata = {
	...
	description:
		'Fridge Mechanics offers expert fridge repair across Buckinghamshire, including Slough, Bracknell, Reading & more. 24/7 service. Call 0777 0777 980 for reliable repairs.',
	keywords:
		'fridge repair Buckinghamshire, refrigerator repair Buckinghamshire, appliance repair Buckinghamshire, fridge service Slough, fridge repair Bracknell, fridge repair Reading, fridge repair Maidenhead, fridge repair Newbury, fridge repair Wokingham, 24/7 fridge repair Buckinghamshire, commercial fridge repair Buckinghamshire, home fridge repair Buckinghamshire, 0777 0777 980, info@fridgemechanics.co.uk',
};
